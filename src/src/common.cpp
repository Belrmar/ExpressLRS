...
expresslrs_mod_settings_s ExpressLRS_AirRateConfig[RATE_MAX] = {
    ...
    {9, RADIO_TYPE_SX128x_LORA, RATE_LORA_50HZ,      SX1280_LORA_BW_0800,         SX1280_LORA_SF9,  SX1280_LORA_CR_LI_4_6, 12, TLM_RATIO_1_16,  2, 20000, OTA4_PACKET_SIZE, 1}};
...
expresslrs_rf_pref_params_s ExpressLRS_AirRateRFperf[RATE_MAX] = {
    ...
    {7, RATE_LORA_150HZ,     -112,  5871, 3500, 2500, 10, 5000, SNR_SCALE( 0), SNR_SCALE(8.5)},
    {8, RATE_LORA_100HZ_8CH, -112,  7605, 3500, 2500, 11, 5000, SNR_SCALE( 0), SNR_SCALE(8.5)},
    {9, RATE_LORA_50HZ,      -117, 18444, 4000, 2500, 0, 5000, SNR_SCALE(-2), SNR_SCALE(5.5)}};
#endif
